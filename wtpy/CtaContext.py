...
class CtaContext:
    ...
    def stra_set_position(self, stdCode: str, qty: float, usertag: str = "", limitprice: float = 0.0,
                          stopprice: float = 0.0):
        """
        设置仓位
        @stdCode   合约/股票代码
    ...
    def stra_enter_long(self, stdCode: str, qty: float, usertag: str = "", limitprice: float = 0.0,
                        stopprice: float = 0.0):
        """
        多仓进场，如果有空仓，则平空再开多
        @stdCode   品种代码
    ...
    def stra_exit_long(self, stdCode: str, qty: float, usertag: str = "", limitprice: float = 0.0,
                       stopprice: float = 0.0):
        """
    ...
    def stra_enter_short(self, stdCode: str, qty: float, usertag: str = "", limitprice: float = 0.0,
                         stopprice: float = 0.0):
        """
        空仓进场，如果有多仓，则平多再开空
        @stdCode   品种代码
    ...
    def stra_exit_short(self, stdCode: str, qty: float, usertag: str = "", limitprice: float = 0.0,
                        stopprice: float = 0.0):
        """
