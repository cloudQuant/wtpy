...
class WtBtEngine:
    ...
    def __init__(self, eType: EngineType = EngineType.ET_CTA, logCfg: str = "logcfgbt.yaml", isFile: bool = True,
                 bDumpCfg: bool = False, outDir: str = "./outputs_bt"):
        """
        构造函数
        @eType  引擎类型
    ...
    def write_indicator(self, ids: str, tag: str, time: int, data: dict):
        ...
        if self.__idx_writer__ is not None:
            self.__idx_writer__.write_indicator(ids, tag, time, data)
    ...
    def setExternalCtaStrategy(self, ids: str, module: str, typeName: str, params: dict):
        """
        添加C++的CTA策略
        @ids 策略IDs
        ...
        self.__config__["cta"]["strategy"]["id"] = ids
        self.__config__["cta"]["strategy"]["name"] = typeName
        self.__config__["cta"]["strategy"]["params"] = params

    def setExternalHftStrategy(self, ids: str, module: str, typeName: str, params: dict):
        """
        添加C++的HFT策略
        @id 策略ID
        ...
        self.__config__["hft"]["strategy"]["id"] = ids
    ...
    def set_sel_strategy(self, strategy: BaseSelStrategy, date: int = 0, time: int = 0, period: str = "d",
                         trdtpl: str = "CHINA", session: str = "TRADING", slippage: int = 0):
        """
        添加SEL策略
        @strategy   策略对象
        """
    ...
    def cta_step(self, remark: str = "") -> bool:
        ...
        @remark 单步 备注信息，没有实际作用，主要用于外部调用区分步骤
        """
