...
class DHTushare(BaseDataHelper):
    ...
    def dmpCodeListToFile(self, filename: str, hasIndex: bool = True, hasStock: bool = True):
        ...
        if hasStock:
            ...
            df_stocks = self.api.stock_basic(exchange='', list_status='L',
    ...
    def __dmp_bars_to_file_from_pro__(self, folder: str, codes: list, start_date: datetime = None,
    ...
    def __dmp_bars_to_file_from_old__(self, folder: str, codes: list, start_date: datetime = None,
                                      end_date: datetime = None, period: str = "day"):
        if start_date is None:
            start_date = datetime(year=1990, month=1, day=1)
    ...
    def dmpBarsToFile(self, folder: str, codes: list, start_date: datetime = None, end_date: datetime = None,
                      period: str = "day"):
        if self.use_pro:
            self.__dmp_bars_to_file_from_pro__(folder=folder, codes=codes, start_date=start_date, end_date=end_date,
                                               period=period)
        else:
            self.__dmp_bars_to_file_from_old__(folder=folder, codes=codes, start_date=start_date, end_date=end_date,
                                               period=period)
    ...
    def __dmp_bars_to_db_from_pro__(self, dbHelper: DBHelper, codes: list, start_date: datetime = None,
                                    end_date: datetime = None, period: str = "day"):
        if start_date is None:
            start_date = datetime(year=1990, month=1, day=1)
    ...
    def __dmp_bars_to_db_from_old__(self, dbHelper: DBHelper, codes: list, start_date: datetime = None,
                                    end_date: datetime = None, period: str = "day"):
        if start_date is None:
            start_date = datetime(year=1990, month=1, day=1)
    ...
    def dmpBarsToDB(self, dbHelper: DBHelper, codes: list, start_date: datetime = None, end_date: datetime = None,
                    period: str = "day"):
        if self.use_pro:
            self.__dmp_bars_to_db_from_pro__(dbHelper=dbHelper, codes=codes, start_date=start_date, end_date=end_date,
                                             period=period)
        else:
            self.__dmp_bars_to_db_from_old__(dbHelper=dbHelper, codes=codes, start_date=start_date, end_date=end_date,
                                             period=period)
